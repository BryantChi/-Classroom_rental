...
function custom_dashboard_footer () {
     echo '網站系統：<font color="blue">Wordpress</font> | 網站設計：<font color="blue">BryantChi</font> | 主機代管：<font color="blue"><a href="mailto:BryantChi.work@gmail.com">MWStudio</a></font>';
  }
